...
class Settings(BaseSettings):
    ...
    # External FastAPI inference endpoint (optional). If set, classifier will POST {"text": "..."}
    # to this URL and expect {"label": str, "confidence": float, "probabilities": {}} in response.
    NLP_INFERENCE_URL: str = ""
    NLP_INFERENCE_AUTH: str = ""  # Authorization header value (e.g. 'Bearer ...') or empty
